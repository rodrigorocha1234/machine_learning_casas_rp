...
class EstrategiaModelo(ABC, Generic[X_in, Y_in, Y_out]):
    ...
    def _plotar_diagnostico_overfitting_underfitting(
        ...
        """Método abstrato. Cada estratégia concreta de regressão deve implementar a geração do seu gráfico com suas particularidades."""
        return None

    def gerar_figura_underfit_overfit(self, dados: dict[str, Any]) -> plt.Figure | None:
        """Gera o objeto plt.Figure delegando para a implementação específica de cada subclasse."""
